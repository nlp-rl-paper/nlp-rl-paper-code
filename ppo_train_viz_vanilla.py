...
if __name__ == "__main__":
    ...
    #scenarios = ["super_scenario","defend_the_line","defend_the_center","health_gathering","basic","health_gathering"]
    scenarios = ["defend_the_center", "super_scenario", "defend_the_line"]
