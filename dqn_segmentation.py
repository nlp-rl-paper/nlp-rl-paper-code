...
def preprocess(img):
    ...
    img = img.reshape([N_CHANNELS,RESOLUTION[0],RESOLUTION[1]])
    return img
...
def perform_learning_step(epoch):
    ...
    s1 = preprocess(lsm.state_to_logic_map(game.get_state()))
    ...
    s2 = preprocess(lsm.state_to_logic_map(game.get_state())) if not isterminal else None
...
if __name__ == '__main__':
    ...
    MODEL_SAVEFILE = "./models/model-doom_seg_" + SCENARIO + "_seed_" + str(SEED) + ".pth"
    ...
    lsm = LogicSegmentMap(N_CHANNELS,(640,480))
        ...
        for epoch in range(EPOCHS):
            ...
            for test_episode in trange(TEST_EPISODES_PER_EPOCH, leave=False):
                ...
                while not game.is_episode_finished():
                    state = preprocess(lsm.state_to_logic_map(game.get_state()))
